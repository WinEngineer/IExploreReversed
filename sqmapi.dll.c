...
typedef struct WIN_CERTIFICATE_9112 WIN_CERTIFICATE_9112, *PWIN_CERTIFICATE_9112;

struct WIN_CERTIFICATE_9112 {
    dword dwLength;
    word wRevision;
    word wCertificateType; // PKCS Signed
    byte bCertificate[9104];
};
